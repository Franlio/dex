...
function Wallet({ deposit, withdraw, user }) {
  // The initial direction is deposit
  const [direction, setDirection] = useState(DIRECTION.DEPOSIT);
  //  The amount of the transfer, the initial value is 0
  ...
  return (
    <div id="wallet" className="card">
      ...
      {/*#1 Show the token balance*/}
      <h3>Token balance for {user.selectedToken.ticker}</h3>
      {/*The balance inside the wallet*/}
      ...
      {/*The balance inside the decentralize exchange*/}
      <div className="form-group row">
